      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 lg:py-16 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="text-muted-foreground text-sm mb-6 max-w-xs">
              Enterprise-grade AI automation that transforms how businesses
              operate. Secure. Smart. Automated.
            </p>
            {/* Social Links */}
        ...
        <div className="py-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Nyvvo. All rights reserved.
          </p>
